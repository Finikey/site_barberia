    ...
    <header class="header">
        <div class="container">
            <div class="header_content">
                ...
                <nav>
                    <ul class="header_ul">
                        <li class="header_li"><a href="?do=exit" class="header_a">Выход</a></li>
                    </ul>
                </nav>
            </div>
        </div>
                ...
                ?>
                        <div class="work_wrapp">
                            ...
                            <div class="wrapp_btn">
                                ...
                                <a href="delete_work.php?id=<?=$app['id']?>" onclick="return confirm('Уверены что хотите отказать?')"><div class="wrap_btn2">
    ...
    <div class="container">
        ...
        <?php 
            if(isset($_POST['add_time'])){
                ...
                if(empty($error)){
                    $sql = "INSERT INTO available_appointments (date,time,time2,time3,time4,time5,time6) VALUES ('$date', '$time', '$time2', '$time3', '$time4', '$time5', '$time6')";
                    $connect -> query($sql);
                    echo'<script>document.location.href="admin.php"</script>';
                }
            }
        ...
        <section class="addfaq">
            <div class="container">
                <div class="addfaq_content">
                    <div class="work_top">
                        <h3 class="top_h3">Добавление даты и времени записи</h3>
                    </div>
                    <div class="addfaq_wrapper">
                        <form action="" class="ff" method="POST" name="add_time">
                            <div class="form_faq">
                                <input type="date" class="faq_input" placeholder="Ответ" name="date">
                                <input type="time" class="faq_input" placeholder="Вопрос" name="time">
                                <input type="time" class="faq_input" placeholder="Вопрос" name="time2">
                                <input type="time" class="faq_input" placeholder="Вопрос" name="time3">
                                <input type="time" class="faq_input" placeholder="Вопрос" name="time4">
                                <input type="time" class="faq_input" placeholder="Вопрос" name="time5">
                                <input type="time" class="faq_input" placeholder="Вопрос" name="time6">
                            </div>
                            <div class="addfaq_inp">
                                <input type="submit" class="faq_place" value="Добавить" name="add_time">
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <section class="addimg">
            <div class="container">
                <div class="addimg_content">
                    <div class="work_top">
                        <h3 class="top_h3">Управление датами записи</h3>
                    </div>
                    <div class="manag_wrapper">
                        <?php 
                            $sql = "SELECT * FROM `available_appointments`";
                            $result = $connect -> query($sql);
                            foreach($result as $ava){
                        ?>
                        <div class="wr_cont">
                        <div class="cont_text">
                                <p class="cont_name"><?=$ava['date']?></p>
                            </div>
                            <div class="cont_right">
                                <!-- <div class="right_svg">
                                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="delete_ava.php?id=<?=$ava['id']?>" onclick="return confirm('Уверены что хотите удалить?')"><div class="right_svg">
                                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.53113 1C5.52364 1 3.19671 3.63591 3.56974 6.62017L5.28873 20.3721C5.47639 21.8734 6.7526 23 8.26557 23H15.7344C17.2474 23 18.5236 21.8734 18.7113 20.3721L20.4303 6.62017C20.8033 3.63591 18.4764 1 15.4689 1H8.53113ZM5.70148 5C6.11066 3.8455 7.21175 3 8.53113 3H15.4689C16.7883 3 17.8893 3.8455 18.2985 5H5.70148ZM5.63279 7L7.27329 20.124C7.33584 20.6245 7.76124 21 8.26557 21H15.7344C16.2388 21 16.6642 20.6245 16.7267 20.124L18.3672 7H5.63279Z" fill="#0F0F0F"/>
                                        <path d="M15.002 10.998C14.6114 10.6075 13.9783 10.6075 13.5878 10.998L12 12.5858L10.4201 11.0058C10.0296 10.6153 9.3964 10.6153 9.00587 11.0058C8.61535 11.3964 8.61535 12.0295 9.00587 12.4201L10.5858 14L9.00001 15.5858C8.60949 15.9763 8.60949 16.6095 9.00001 17C9.39054 17.3905 10.0237 17.3905 10.4142 17L12 15.4142L13.5878 17.0019C13.9783 17.3925 14.6114 17.3925 15.002 17.0019C15.3925 16.6114 15.3925 15.9782 15.002 15.5877L13.4142 14L15.002 12.4123C15.3925 12.0217 15.3925 11.3886 15.002 10.998Z" fill="#0F0F0F"/>
                                    </svg>
        ...
        <?php 
            if(isset($_POST['add_barber'])){
                ...
                if(empty($error)){
                    $sql = "INSERT INTO barbers (name) VALUES ('$name')";
                    $connect -> query($sql);
                    echo'<script>document.location.href="admin.php"</script>';
                }
            }
        ...
        <section class="addfaq">
            <div class="container">
                <div class="addfaq_content">
                    <div class="work_top">
                        <h3 class="top_h3">Добавление барбера</h3>
                    </div>
                    <div class="addfaq_wrapper">
                        <form action="" class="ff" method="POST" name="add_barber">
                            <div class="form_faq">
                                <input type="text" class="faq_input" placeholder="Имя барбера" name="name">
                            </div>
                            <div class="addfaq_inp">
                                <input type="submit" class="faq_place" value="Добавить" name="add_barber">
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <section class="addimg">
            <div class="container">
                <div class="addimg_content">
                    <div class="work_top">
                        <h3 class="top_h3">Управление барберами</h3>
                    </div>
                    <div class="manag_wrapper">
                        <?php 
                            $sql = "SELECT * FROM `barbers`";
                            $result = $connect -> query($sql);
                            foreach($result as $barb){
                        ?>
                        <div class="wr_cont">
                        <div class="cont_text">
                                <p class="cont_name"><?=$barb['name']?></p>
                            </div>
                            <div class="cont_right">
                                <!-- <div class="right_svg">
                                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="delete_barber.php?id=<?=$barb['id']?>" onclick="return confirm('Уверены что хотите удалить?')"><div class="right_svg">
                                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.53113 1C5.52364 1 3.19671 3.63591 3.56974 6.62017L5.28873 20.3721C5.47639 21.8734 6.7526 23 8.26557 23H15.7344C17.2474 23 18.5236 21.8734 18.7113 20.3721L20.4303 6.62017C20.8033 3.63591 18.4764 1 15.4689 1H8.53113ZM5.70148 5C6.11066 3.8455 7.21175 3 8.53113 3H15.4689C16.7883 3 17.8893 3.8455 18.2985 5H5.70148ZM5.63279 7L7.27329 20.124C7.33584 20.6245 7.76124 21 8.26557 21H15.7344C16.2388 21 16.6642 20.6245 16.7267 20.124L18.3672 7H5.63279Z" fill="#0F0F0F"/>
                                        <path d="M15.002 10.998C14.6114 10.6075 13.9783 10.6075 13.5878 10.998L12 12.5858L10.4201 11.0058C10.0296 10.6153 9.3964 10.6153 9.00587 11.0058C8.61535 11.3964 8.61535 12.0295 9.00587 12.4201L10.5858 14L9.00001 15.5858C8.60949 15.9763 8.60949 16.6095 9.00001 17C9.39054 17.3905 10.0237 17.3905 10.4142 17L12 15.4142L13.5878 17.0019C13.9783 17.3925 14.6114 17.3925 15.002 17.0019C15.3925 16.6114 15.3925 15.9782 15.002 15.5877L13.4142 14L15.002 12.4123C15.3925 12.0217 15.3925 11.3886 15.002 10.998Z" fill="#0F0F0F"/>
                                    </svg>
        ...
        <?php 
            if(isset($_POST['add_hair'])){
                ...
                if(empty($error)){
                    $sql = "INSERT INTO haircuts (haircut) VALUES ('$haircut')";
                    $connect -> query($sql);
                    echo'<script>document.location.href="admin.php"</script>';
                }
            }
        ...
        <section class="addfaq">
            <div class="container">
                <div class="addfaq_content">
                    <div class="work_top">
                        <h3 class="top_h3">Добавление услуги в бота</h3>
                    </div>
                    <div class="addfaq_wrapper">
                        <form action="" class="ff" method="POST" name="add_hair">
                            <div class="form_faq">
                                <input type="text" class="faq_input" placeholder="Название услуги" name="haircut">
                            </div>
                            <div class="addfaq_inp">
                                <input type="submit" class="faq_place" value="Добавить" name="add_hair">
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <section class="addimg">
            <div class="container">
                <div class="addimg_content">
                    <div class="work_top">
                        <h3 class="top_h3">Управление услугами в боте</h3>
                    </div>
                    <div class="manag_wrapper">
                        <?php 
                            $sql = "SELECT * FROM `haircuts`";
                            $result = $connect -> query($sql);
                            foreach($result as $hair){
                        ?>
                        <div class="wr_cont">
                        <div class="cont_text">
                                <p class="cont_name"><?=$hair['haircut']?></p>
                            </div>
                            <div class="cont_right">
                                <!-- <div class="right_svg">
                                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="delete_hair.php?id=<?=$hair['id']?>" onclick="return confirm('Уверены что хотите удалить?')"><div class="right_svg">
                                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.53113 1C5.52364 1 3.19671 3.63591 3.56974 6.62017L5.28873 20.3721C5.47639 21.8734 6.7526 23 8.26557 23H15.7344C17.2474 23 18.5236 21.8734 18.7113 20.3721L20.4303 6.62017C20.8033 3.63591 18.4764 1 15.4689 1H8.53113ZM5.70148 5C6.11066 3.8455 7.21175 3 8.53113 3H15.4689C16.7883 3 17.8893 3.8455 18.2985 5H5.70148ZM5.63279 7L7.27329 20.124C7.33584 20.6245 7.76124 21 8.26557 21H15.7344C16.2388 21 16.6642 20.6245 16.7267 20.124L18.3672 7H5.63279Z" fill="#0F0F0F"/>
                                        <path d="M15.002 10.998C14.6114 10.6075 13.9783 10.6075 13.5878 10.998L12 12.5858L10.4201 11.0058C10.0296 10.6153 9.3964 10.6153 9.00587 11.0058C8.61535 11.3964 8.61535 12.0295 9.00587 12.4201L10.5858 14L9.00001 15.5858C8.60949 15.9763 8.60949 16.6095 9.00001 17C9.39054 17.3905 10.0237 17.3905 10.4142 17L12 15.4142L13.5878 17.0019C13.9783 17.3925 14.6114 17.3925 15.002 17.0019C15.3925 16.6114 15.3925 15.9782 15.002 15.5877L13.4142 14L15.002 12.4123C15.3925 12.0217 15.3925 11.3886 15.002 10.998Z" fill="#0F0F0F"/>
                                    </svg>
                ...
                <div class="sign_content">
                    ...
                    <form class="sign_wrapp" method="POST" name="reg">
                        <div  class="sign_form">
                            ...
                            <input type="submit" value="Вход" class="sign_sub" name="reg">
